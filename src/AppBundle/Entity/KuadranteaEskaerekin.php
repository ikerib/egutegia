...
/**
 * KuadranteaEskaerekin
 *
 * @ORM\Table(name="kuadrantea_eskaerekin")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\KuadranteaEskaerekinRepository")
 */
class KuadranteaEskaerekin
{
    /**
     * @var int
     *
     ...
     * Set urtea.
     *
     * @param int|null $urtea
     *
     * @return KuadranteaEskaerekin
     */
    public function setUrtea($urtea = null)
    {
        $this->urtea = $urtea;
     ...
     * Set hilabetea.
     *
     * @param string|null $hilabetea
     *
     * @return KuadranteaEskaerekin
     */
    public function setHilabetea($hilabetea = null)
    {
